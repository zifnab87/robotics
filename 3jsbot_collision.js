...
function traverse_collision_forward_kinematics_joint(joint,mstack,q) {
    ...
    var local_xform = matrix_multiply(generate_translation_matrix(joint.origin.xyz),matrix_multiply(matrix_multiply(generate_rotation_matrix_Z(joint.origin.rpy[2]),generate_rotation_matrix_Y(joint.origin.rpy[1])),generate_rotation_matrix_X(joint.origin.rpy[0])));
