...
function user_input() {
    ...
    if ( keyboard.pressed("n") |  keyboard.pressed("b")) {
        if (typeof robot_path !== 'undefined') {
            ...
            // increment index
            if ((keyboard.pressed("n"))&&(robot_path_traverse_idx<robot_path.length-1)) robot_path_traverse_idx++;
            if ((keyboard.pressed("b"))&&(robot_path_traverse_idx>0)) robot_path_traverse_idx--;
